...
const Footer = () => {
  return (
    <div className="section-container mt-20">
      <footer className="footer xl:px-10 py-10 bg-base-200 px-4 text-base-content">
        <aside>
          ...
          <p className="my-5">
            Survo analytics Inc.
            <br />
            Providing insightful analytics since 2023
          </p>
        </aside>
        <nav>
      ...
      <footer className="footer items-center p-4 bg-base-200 text-black xl:px-10">
